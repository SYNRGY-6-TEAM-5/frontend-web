  ...
  return (
    <div className="xs:w-fit mx-auto w-full px-4 pt-24 md:px-0">
      <div className="xs:px-8 px-3 py-8">
        ...
        <label
          htmlFor="phone"
          className="text-gray-300 hover:border-primary-200 hover:text-primary-200 group flex border-b py-3 has-[:checked]:border-primary-500 has-[:checked]:text-primary-500"
        >
          <Phone size={24} />
