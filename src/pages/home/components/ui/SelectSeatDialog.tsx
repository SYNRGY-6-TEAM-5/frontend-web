...
const SelectSeatDialog: React.FC<CardProps & { onTicketDetails: (details: Seat) => void }> = ({
  className,
  onTicketDetails,
  ...props
}) => {
              ...
              <div className=" flex items-center border-b p-4">
                ...
                <form className="mx-auto max-w-xs">
                  <div className="relative flex max-w-[11rem] items-center">
                    ...
                    >
                      <MinusCircledIcon className="flex h-6 w-6 items-center rounded-full hover:bg-slate-600 hover:shadow-md" />
                    </button>
                    <input
                      type="text"
                      id="adult-seat-input"
                    ...
                    <button
                      ...
                      className="h-11 rounded-e-lg"
                    >
                      <PlusCircledIcon className="flex h-6 w-6 items-center rounded-full hover:bg-slate-600 hover:shadow-md" />
                    </button>
                  </div>
                </form>
              </div>
