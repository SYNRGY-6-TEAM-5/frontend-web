        ...
        <DrawerContent className="max-h-[90vh] w-full">
          <div className="overflow-auto">
            <div ref={myElementRef} className="bg-white p-4">
              <DrawerHeader>
                <DrawerTitle>Boarding Pass</DrawerTitle>
              </DrawerHeader>
              <div>
                <SelectPassanger
              ...
              <div className="mt-6 flex justify-between">
                <Text className="text-7xl font-medium">
                  {
                    booking.tickets[0].flight.departure.airport_details
                      .iata_code
                  }
                </Text>
                <Text className="text-7xl font-medium">
            ...
            <div className="p-4">
              <Button
                className="mb-4 h-14 w-full rounded-xl bg-primary-500 text-xs font-medium text-white hover:bg-primary-500/80"
                type="button"
